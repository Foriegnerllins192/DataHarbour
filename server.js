...
// Critical Error Handling: Catch uncaught exceptions to prevent silent crashes
...
// Trust proxy for Render/Cloud hosting (required for secure cookies)
...
app.use((err, req, res, next) => {
  ...
  // For HTML requests, send a generic error page or redirect
