# PostgreSQL Database Setup for DataHarbour

This guide will help you set up the PostgreSQL database for the DataHarbour mobile data selling website using Supabase.
...
1. Copy the contents of `dataharbour_postgresql.sql` from this project
