...
This document summarizes all the changes made to migrate the DataHarbour application from MySQL to PostgreSQL with Supabase.
...
**New File:** `dataharbour_postgresql.sql`
...
4. **Import Database Schema**
   - Copy contents of `dataharbour_postgresql.sql`
