# DataHarbour Project Setup Guide

This guide will help you set up the DataHarbour mobile data selling website with PostgreSQL database using Supabase.
...
3. Copy the contents of `dataharbour_postgresql.sql` from this project
...
SMTP_FROM=no-reply@dataharbour.com
```
