...
This guide will help you set up the MySQL database for the DataHarbour mobile data selling website using XAMPP.

**Note:** If you want data bundles without validity periods (so they don't expire), please use `DATABASE_SETUP_NO_VALIDITY.md` instead and import `dataharbour_no_validity.sql`.
...
5. Select the `dataharbour.sql` file
