...
async function sendFailureNotification(user, transaction, errorMessage) {
  try {
    ...
    try {
      const smsMessage = `
DataHarbour - Transaction Failed
...
Please try again or contact support@dataharbour.com

Thank you for choosing DataHarbour!
      `;
    ...
    try {
      const subject = 'DataHarbour - Transaction Failed';
      const html = `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
          <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="background: #f8f9fa; padding: 20px; text-align: center; border-radius: 8px 8px 0 0;">
              <h1 style="color: #dc3545; margin: 0;">DataHarbour</h1>
            ...
            <div style="padding: 30px; background: white; border: 1px solid #eee; border-top: none; border-radius: 0 0 8px 8px;">
              ...
              <p>Please try again or contact our support team at support@dataharbour.com if you continue to experience issues.</p>
