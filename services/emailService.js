...
class EmailService {
  constructor() {
    ...
    this.from = process.env.SMTP_FROM || 'no-reply@dataharbour.com';
  }
  ...
  async sendPaymentConfirmation(to, transaction, user, plan) {
    const subject = 'DataHarbour - Payment Confirmation';
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="background: #f8f9fa; padding: 20px; text-align: center; border-radius: 8px 8px 0 0;">
            <h1 style="color: #007bff; margin: 0;">DataHarbour</h1>
          ...
          <div style="padding: 30px; background: white; border: 1px solid #eee; border-top: none; border-radius: 0 0 8px 8px;">
            ...
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee; text-align: center; color: #666;">
              <p>Thank you for choosing DataHarbour!</p>
              <p><small>DataHarbour - Your trusted mobile data provider</small></p>
            </div>
          </div>
        </div>
      </body>
  ...
  async sendAdminAlert(subject, message, details = {}) {
    ...
    const html = `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="background: #f8f9fa; padding: 20px; text-align: center; border-radius: 8px 8px 0 0;">
            <h1 style="color: #dc3545; margin: 0;">DataHarbour Admin Alert</h1>
          </div>
          ...
          <div style="padding: 30px; background: white; border: 1px solid #eee; border-top: none; border-radius: 0 0 8px 8px;">
            ...
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee; text-align: center; color: #666;">
              <p>This is an automated alert from DataHarbour system.</p>
            </div>
          </div>
        </div>
      </body>
    ...
    return this.sendEmail(adminEmail, `[DataHarbour Alert] ${subject}`, html);
  }
}
